...
$(function () {
    ...
    jQuery(function($) {
        ...
        var SiteManager = function() {
            ...
            //Call Us modal
            this.initCallUsModal = function() {
                var $modal = $('.js-call-us-modal');
                var $modaltrigger = $('.js-call-us');
            ...
            this.initAsidetrigger = function() {
                var $trigger = $('.js-aside-trigger');
        ...
        siteManager.IEviewportFix();
        siteManager.initAnchorScroll();
        siteManager.initCallUsModal();
        siteManager.initAsidetrigger();
        siteManager.initFilterPosts();
        siteManager.hoverMenu();
    });
